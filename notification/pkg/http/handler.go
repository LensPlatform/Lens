...
func makeSendEmailHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
...
func makeSendWelcomeToLensEmailHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
...
func makeSendPasswordChangeEmailHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
...
func makeSendEmailAccountResetEmailHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
