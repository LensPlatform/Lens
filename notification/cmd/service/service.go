...
import (
	...
	grpc "github.com/LensPlatform/Lens-Backend/notification/pkg/grpc"
	pb "github.com/LensPlatform/Lens-Backend/notification/pkg/grpc/pb"
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "notification")
