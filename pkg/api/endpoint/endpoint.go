...
func MakeCreateUserAccountEndpoint(s service.UsersService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		id, e0 := s.CreateUserAccount(ctx, req.User, req.UserType)
		return CreateUserAccountResponse{Id: id, E0: e0}, nil
	}
}
...
func MakeUpdateUserAccountEndpoint(s service.UsersService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		id, e0 := s.UpdateUserAccount(ctx, req.User, req.Id)
		return UpdateUserAccountResponse{Id: id, E0: e0}, nil
	}
}
...
func MakeDeleteUserAccountEndpoint(s service.UsersService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		id, e0 := s.DeleteUserAccount(ctx, req.Id)
		return DeleteUserAccountResponse{Id: id, E0: e0}, nil
	}
}
...
func MakeAddUserToTeamsAccountEndpoint(s service.UsersService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		id, e0 := s.AddUserToTeamsAccount(ctx, req.TeamID, req.UserID)
		return AddUserToTeamsAccountResponse{Id: id, E0: e0}, nil
	}
}
...
func MakeDeleteUserFromTeamsAccountEndpoint(s service.UsersService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		id, e0 := s.DeleteUserFromTeamsAccount(ctx, req.TeamID, req.UserID)
		return DeleteUserFromTeamsAccountResponse{Id: id, E0: e0}, nil
	}
}
...
func MakeCreateGroupEndpoint(s service.UsersService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		id, e0 := s.CreateGroup(ctx, req.GroupName, req.GroupType, req.IsPrivate)
		return CreateGroupResponse{Id: id, E0: e0}, nil
	}
}
...
func MakeSubscribeToGroupEndpoint(s service.UsersService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		id, e0 := s.SubscribeToGroup(ctx, req.GroupID, req.ID)
		return SubscribeToGroupResponse{Id: id, E0: e0}, nil
	}
}
...
func MakeUnsubscribeFromGroupEndpoint(s service.UsersService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		id, e0 := s.UnsubscribeFromGroup(ctx, req.GroupID, req.ID)
		return UnsubscribeFromGroupResponse{Id: id, E0: e0}, nil
	}
}
...
func MakeDeleteGroupEndpoint(s service.UsersService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		id, e0 := s.DeleteGroup(ctx, req.GroupID, req.GroupAdminID)
		return DeleteGroupResponse{Id: id, E0: e0}, nil
	}
}
...
func (e Endpoints) CreateUserAccount(ctx context.Context, user interface{}, userType string) (id string, e0 error) {
	...
	return response.(CreateUserAccountResponse).Id, response.(CreateUserAccountResponse).E0
}

// UpdateUserAccount implements Service. Primarily useful in a client.
func (e Endpoints) UpdateUserAccount(ctx context.Context, user interface{}, id string) (userID string, e0 error) {
	...
	return response.(UpdateUserAccountResponse).Id, response.(UpdateUserAccountResponse).E0
}

// DeleteUserAccount implements Service. Primarily useful in a client.
func (e Endpoints) DeleteUserAccount(ctx context.Context, id string) (userID string, e0 error) {
	request := DeleteUserAccountRequest{Id: id}
	response, err := e.DeleteUserAccountEndpoint(ctx, request)
	if err != nil {
		return
	}
	return response.(DeleteUserAccountResponse).Id, response.(DeleteUserAccountResponse).E0
}
...
func (e Endpoints) CreateTeamsAccount(ctx context.Context, team interface{}, teamType string) (id string, e0 error) {
	...
	return response.(CreateTeamsAccountResponse).Id, response.(CreateTeamsAccountResponse).E0
}

// UpdateTeamsAccount implements Service. Primarily useful in a client.
func (e Endpoints) UpdateTeamsAccount(ctx context.Context, team interface{}, teamID string) (id string, e0 error) {
	...
	return response.(UpdateTeamsAccountResponse).Id, response.(UpdateTeamsAccountResponse).E0
}

// DeleteTeamsAccount implements Service. Primarily useful in a client.
func (e Endpoints) DeleteTeamsAccount(ctx context.Context, teamID string) (id string, e0 error) {
	request := DeleteTeamsAccountRequest{TeamID: teamID}
	response, err := e.DeleteTeamsAccountEndpoint(ctx, request)
	if err != nil {
		return
	}
	return response.(DeleteTeamsAccountResponse).Id, response.(DeleteTeamsAccountResponse).E0
}
...
func (e Endpoints) AddUserToTeamsAccount(ctx context.Context, teamID string, userID string) (id string, e0 error) {
	...
	return response.(AddUserToTeamsAccountResponse).Id, response.(AddUserToTeamsAccountResponse).E0
}

// DeleteUserFromTeamsAccount implements Service. Primarily useful in a client.
func (e Endpoints) DeleteUserFromTeamsAccount(ctx context.Context, teamID string, userID string) (id string, e0 error) {
	...
	return response.(DeleteUserFromTeamsAccountResponse).Id, response.(DeleteUserFromTeamsAccountResponse).E0
}

// CreateGroup implements Service. Primarily useful in a client.
func (e Endpoints) CreateGroup(ctx context.Context, groupName string, groupType string, isPrivate bool) (id string, e0 error) {
	...
	return response.(CreateGroupResponse).Id, response.(CreateGroupResponse).E0
}

// SubscribeToGroup implements Service. Primarily useful in a client.
func (e Endpoints) SubscribeToGroup(ctx context.Context, groupID string, ID string) (id string, e0 error) {
	...
	return response.(SubscribeToGroupResponse).Id, response.(SubscribeToGroupResponse).E0
}

// UnsubscribeFromGroup implements Service. Primarily useful in a client.
func (e Endpoints) UnsubscribeFromGroup(ctx context.Context, groupID string, ID string) (id string, e0 error) {
	...
	return response.(UnsubscribeFromGroupResponse).Id, response.(UnsubscribeFromGroupResponse).E0
}

// DeleteGroup implements Service. Primarily useful in a client.
func (e Endpoints) DeleteGroup(ctx context.Context, groupID string, groupAdminID string) (id string, e0 error) {
