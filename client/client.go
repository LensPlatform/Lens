// Package client provides a svc client based on a predefined Consul
...
// New returns a service that's load-balanced over instances of svc found
// in the provided Consul server. The mechanism of looking up svc
...
func New(consulAddr string, logger log.Logger) (profilesvc.Service, error) {
	...
	// As the implementer of svc, we declare and enforce these
	// parameters for all of the svc consumers.
	var (
		consulService = "svc"
