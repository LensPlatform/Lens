...
import (
	...
	endpoint "github.com/LensPlatform/Lens-Backend/social/pkg/endpoint"
	grpc "github.com/LensPlatform/Lens-Backend/social/pkg/grpc"
	pb "github.com/LensPlatform/Lens-Backend/social/pkg/grpc/pb"
	service "github.com/LensPlatform/Lens-Backend/social/pkg/service"
...
var fs = flag.NewFlagSet("social", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "social")
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterSocialServer(baseServer, grpcServer)
